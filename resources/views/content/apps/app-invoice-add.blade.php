    ...
    <div class="card invoice-preview-card">
      ...
      <div class="card-body">
        <form class="source-item pt-1">
          ...
          <div class="row">
            <div class="col-12">
              <button type="button" class="btn btn-sm btn-primary" data-repeater-create><i class="mdi mdi-plus me-1"></i> Add Item</button>
            </div>
          </div>
        </form>
      </div>
        ...
        <div class="row">
          <div class="col-md-6 mb-md-0 mb-3">
            <div class="form-floating form-floating-outline mb-4">
              ...
              <label for="salesperson" class="fw-medium">Salesperson</label>
            </div>
            <div class="form-floating form-floating-outline mb-4">

    ...
    <div class="col-12">
      <form class="kanban-add-new-board">
        ...
        <div class="mb-3 kanban-add-board-input d-none">
          ...
          <button type="button" class="btn btn-outline-secondary btn-sm kanban-add-board-cancel-btn">{{__('Cancel')}}</button>
        </div>
      </form>
    </div>
  </div>
      ...
      <div class="tab-content px-0 pb-0">
        ...
        <div class="tab-pane fade" id="tab-activity" role="tabpanel">
          ...
          <div class="media mb-4 d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <p class="mb-0">
                <span class="fw-medium text-heading">Dianna</span> mentioned
          ...
          <div class="media mb-4 d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <p class="mb-0">
                <span class="fw-medium text-heading">Martian</span> added moved
          ...
          <div class="media mb-4 d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <p class="mb-0">
                <span class="fw-medium text-heading">Barry</span> Commented on App
                review task.
              </p>
          ...
          <div class="media mb-4 d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <p class="mb-0">
                <span class="fw-medium text-heading">Bruce</span> was assigned
                task of code review.
              </p>
          ...
          <div class="media mb-4 d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <p class="mb-0">
                <span class="fw-medium text-heading">Clark</span> assigned task UX
                Research to
          ...
          <div class="media mb-4 d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <p class="mb-0">
                <span class="fw-medium text-heading">Ray</span> Added moved
                <span class="fw-medium text-heading">Forms & Tables</span> task
          ...
          <div class="media mb-4 d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <p class="mb-0">
                <span class="fw-medium text-heading">Barry</span> Complete all the
          ...
          <div class="media mb-4 d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <p class="mb-0">
                <span class="fw-medium text-heading">Jordan</span> added task to
                update new images.
              </p>
          ...
          <div class="media mb-4 d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <p class="mb-0">
                <span class="fw-medium text-heading">Dianna</span> moved task
          ...
          <div class="media mb-4 d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <p class="mb-0">
                <span class="fw-medium text-heading">Clark</span> added new board
                with name <span class="fw-medium text-heading">Done</span>.
              </p>
          ...
          <div class="media d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <p class="mb-0">
                <span class="fw-medium text-heading">Bruce</span> added new task
                in progress board.
              </p>

  ...
  @if(!$exists)
    <div class="row">
      <div class="col-12 text-danger">
        <h5>{{$cvrm}} çevrimi için kayıt bulunamadı.</h5>
        <br/>
      </div>
    </div>
  @endif
...
//  $pot = array_merge($pot, $basvurubgys);
  ...
  $asamastr = ($asama === "ilkplan") ? "İlk Belgelendirme" :
    (($asama === "g1") ? "1. Gözetim" :
      (($asama === "g2") ? "2. Gözetim" :
        (($asama === "yb") ? "Yeniden Belgelendirme" :
          (($asama === "ozel") ? "Özel Denetim" : "-"))));
...
// Her alanı belirli bir karakter ile başlat, ancak boşsa ekleme
  $nace = !empty($nace) ? "|" . $nace : "";
  $kat = !empty($kat) ? "@" . $kat : "";
  $oickat = !empty($oickat) ? "ß" . $oickat : "";
  $enysteknikalan = !empty($enysteknikalan) ? "Æ" . $enysteknikalan : "";
  $bgkat = !empty($bgkat) ? "€" . $bgkat : "";

// Tüm değerleri birleştir
  $katnace = $ea . $nace . $kat . $oickat . $enysteknikalan . $bgkat;

// Eğer en sonda istenmeyen karakterlerden biri varsa, temizle
  $katnace = rtrim($katnace, "|@ßÆ€");
...
// Çıktıyı yazdır
  ...
  $smiicvarmi = App\Http\Controllers\Planlama\Plan::anyOicSmiicTrue($oicsmiic, $oicsmiic6, $oicsmiic9, $oicsmiic171, $oicsmiic23, $oicsmiic24);


  $hasOtherStandards = isset($iso900115) || isset($iso1400115) || isset($iso4500118) ||
    isset($iso2200018) || isset($helal) || isset($oicsmiik6) ||
    isset($oicsmiik9) || isset($oicsmiik171) || isset($oicsmiik23) ||
    isset($oicsmiik24);

  // Gösterilecek ekstra div sayısını hesapla
  $extraDivCount = 0;
  if ($iso50001) $extraDivCount++;
  if ($iso27001) $extraDivCount++;

  // Col genişliğini hesapla
  $colWidth = 8;
  if ($extraDivCount == 1) $colWidth = 6;
  if ($extraDivCount == 2) $colWidth = 4;

  $effectiveEmployeeCount = $pot->toplamcalisansayisi;
  if ($iso50001 && !$iso27001 && !$hasOtherStandards) {
    $effectiveEmployeeCount = $basvuruenys->enyseffectiveemployee;
  } elseif (!$iso50001 && $iso27001 && !$hasOtherStandards) {
    $effectiveEmployeeCount = $basvurubgys->bgyseffectiveemployee;
  }

  $inceleneceksahasayisi = (!is_null($pot->inceleneceksahasayisi) && intval($pot->inceleneceksahasayisi) > 0) ? intval($pot->inceleneceksahasayisi) : 0;

//  if($iso2200018 && intval($pot->sahasayisi22) == 1)
  ...
  $bitistarihi = ($bitistarihi != "") ? date_format($bitistarihi, "d.m.Y") : "-";
  ?>
              ...
              <div class="col-sm-6 col-lg-4">
                <div class="d-flex justify-content-between align-items-start card-widget-1 border-end pb-3 pb-sm-0">
                  <div class="input-group">
                    <select id="cevrim" class="selectpicker w-150"
                            data-style="btn-default" onchange="changeCevrim()">
                      <option value="0" readonly selected>Çevrim seçiniz...</option>
                      <option value="1"{{$cevrim == 1 ? " selected" : ""}}>1. Çevrim</option>
                      <option value="2"{{$cevrim == 2 ? " selected" : ""}}>2. Çevrim</option>
                      <option value="3"{{$cevrim == 3 ? " selected" : ""}}>3. Çevrim</option>
                      <option value="4"{{$cevrim == 4 ? " selected" : ""}}>4. Çevrim</option>
                      <option value="5"{{$cevrim == 5 ? " selected" : ""}}>5. Çevrim</option>
                    </select>
                    <button type="button" class="btn btn-icon btn-primary btn-group-sm"
                            onclick="changeCevrim()">
...
{{--                    <p class="mb-0">Sertifika Geçerlilik Tarihi</p>--}}
              ...
              {{--                  <div>--}}
              {{--                    <h5 class="mb-1">--}}
              {{--                      <div id="lbl_ea">{{$ea}}</div><br>--}}
              {{--                      <div id="lbl_enys">{{$enysteknikalan}}</div>--}}
              {{--                    </h5>--}}
              {{--                    <p class="mb-0">&nbsp;</p>--}}
              {{--                  </div>--}}
              {{--                  <div class="avatar">--}}
    ...
    <div class="row gy-4 mb-4">
      <div class="col-xl-12">
        <form id="planlama-form" onSubmit="return false">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <input type="hidden" id="cevrimYenileRoute" value="{{url('cevrimGetir')}}">
              ...
              <input type="hidden" id="digersistemlerneler" name="digersistemlerneler"
                     value="{{$pot->digersistemlerneler}}">
              ...
              <input type="hidden" id="enyseffectiveemployee" name="enyseffectiveemployee"
                     value="<?php echo $basvuruenys->enyseffectiveemployee; ?>">
              <input type="hidden" id="bgyseffectiveemployee" name="bgyseffectiveemployee"
                     value="<?php echo $basvurubgys->bgyseffectiveemployee; ?>">
              <div class="row g-4">
                <div class="col-sm-2">
                  <div class="input-group input-group-merge">
                    <div class="form-floating form-floating-outline">
                      ...
                      <label for="toplamcalisansayisi">
                        @if($iso50001 && !$iso27001 && !$hasOtherStandards)
                          EnYs Efektif Çalışan Sayısı
                        @elseif(!$iso50001 && $iso27001 && !$hasOtherStandards)
                          BgYs Efektif Çalışan Sayısı
                        @else
                ...
                @if($iso50001)
                  <div class="col-sm-2">
                    <div class="input-group input-group-merge">
                      <div class="form-floating form-floating-outline">
                        EnYs Efektif Çalışan Sayısı<br>{{$basvuruenys->enyseffectiveemployee}}
                      </div>
                    </div>
                  </div>
                @endif
                @if($iso27001)
                  <div class="col-sm-2">
                    <div class="input-group input-group-merge">
                      <div class="form-floating form-floating-outline">
                        BgYs Efektif Çalışan Sayısı<br>{{$basvurubgys->bgyseffectiveemployee}}
                      </div>
                    </div>
                  </div>
                @endif
                ...
                <div class="col-sm-{{$smiicvarmi ? "3" : "6"}}">
                  <div class="input-group input-group-merge">
                    <div class="form-floating form-floating-outline">
                ...
                <div class="col-sm-{{$smiicvarmi ? "3" : "4"}}">
                        ...
                        <div id="planlamatabs" class="nav-align-left">
                          ...
                          <div class="tab-content">
                            ...
                            >
                              ...
                              <fieldset @if($asama !== 'ilkplan') disabled @endif>
                                <div class="card mb-4">
                                      ...
                                      <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                          ...
                                          <button class="btn btn-primary" type="button"
                                                  onclick="denetcikontrol('asama1tar')">
                                    ...
                                    <div class="row g-1 mb-1">
                                      ...
                                      <div class="col-sm-6">
                                        <div class="input-group">
                                          ...
                                          <input type="text" id="diviku1" name="iku1" class="form-control"
                                                 placeholder=""
                                                 value="{{$iku1}}"
                                      ...
                                      <div class="col-sm-12">
                                        <div class="input-group">
                                          ...
                                          <input type="text" id="divsid1" name="sid1" class="form-control"
                                                 placeholder=""
                                                 value=""
                                    ...
                                    <div class="row g-1 mb-1">
                                      ...
                                      <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                          ...
                                          <button class="btn btn-primary" type="button"
                                                  onclick="denetcikontrol('asama2tar')">
                                            <span class="mdi mdi-database-search"></span>
                                          </button>
                                        </div>
                                      </div>
                                    ...
                                    <div class="row g-1 mb-1">
                                      ...
                                      <div class="col-sm-6">
                                        <div class="input-group">
                                          ...
                                          <input type="text" id="diviku2" name="iku2" class="form-control"
                                                 placeholder=""
                                                 value="{{$iku2}}"
                                                 aria-label="İslami uzman seçiniz">
                                        </div>
                                      ...
                                      <div class="col-sm-12">
                                        <div class="input-group">
                                          ...
                                          <input type="text" id="divsid2" name="sid2" class="form-control"
                                                 placeholder=""
                                                 value=""
                                                 aria-label="Değerlendirici seçiniz">
                                        </div>
                            ...
                            <div class="tab-pane fade{{ $tab2show }}{{ $tab2 }}"
                                 ...
                                 role="tabpanel"
                            >
                              <fieldset @if($asama !== 'g1') disabled @endif>
                                <div class="row g-1 mb-1">
                                  <div class="col-sm-2">
                                    <div class="input-group input-group-merge">
                                      <div class="form-floating form-floating-outline">
                                  ...
                                  <div class="col-sm-4">
                                    <div class="input-group input-group-merge">
                                      ...
                                      <button class="btn btn-primary" type="button"
                                              onclick="denetcikontrol('gozetim1tar')">
                                        <span class="mdi mdi-database-search"></span>
                                      </button>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-sm-2">
                                    <div class="form-floating form-floating-outline">
                                      <div class="form-check mt-3">
                                        <input class="form-check-input" type="checkbox" value="1"
                                               id="kapsamgenisletme"
                                               name="kapsamgenisletme" {{($pot->kapsamgenisletme === 1) ? 'checked' : ''}} />
                            ...
                            <div class="tab-pane fade{{ $tab3show }}{{ $tab3 }}"
                                 ...
                                 role="tabpanel"
                            >
                              <fieldset @if($asama !== 'g2') disabled @endif>
                                <div class="row g-1 mb-1">
                                  <div class="col-sm-2">
                                    <div class="input-group input-group-merge">
                                      <div class="form-floating form-floating-outline">
                                  ...
                                  <div class="col-sm-4">
                                    <div class="input-group input-group-merge">
                                      ...
                                      <button class="btn btn-primary" type="button"
                                              onclick="denetcikontrol('gozetim2tar')">
                                        <span class="mdi mdi-database-search"></span>
                                      </button>
                                    </div>
                                  </div>
                            ...
                            <div class="tab-pane fade{{ $tab4show }}{{ $tab4 }}"
                                 ...
                                 role="tabpanel"
                            >
                              <fieldset @if($asama !== 'yb') disabled @endif>
                                <div class="row g-1 mb-1">
                                  <div class="col-sm-2">
                                    <div class="input-group input-group-merge">
                                      <div class="form-floating form-floating-outline">
                                  ...
                                  <div class="col-sm-4">
                                    <div class="input-group input-group-merge">
                                      ...
                                      <button class="btn btn-primary" type="button" onclick="denetcikontrol('ybtar')">
                                        <span class="mdi mdi-database-search"></span>
                                      </button>
                                    </div>
                                  </div>
                            ...
                            <div class="tab-pane fade{{ $tab5show }}{{ $tab5 }}"
                                 ...
                                 role="tabpanel"
                            >
                              <fieldset @if($asama !== 'ozel') disabled @endif>
                                <div class="row g-1 mb-1">
                                  <div class="col-sm-2">
                                    <div class="input-group input-group-merge">
                                      <div class="form-floating form-floating-outline">
                                  ...
                                  <div class="col-sm-4">
                                    <div class="input-group input-group-merge">
                                      ...
                                      <button class="btn btn-primary" type="button" onclick="denetcikontrol('ozeltar')">
                                        <span class="mdi mdi-database-search"></span>
                                      </button>
                                    </div>
                                  </div>
                            ...
                            <div class="card overflow-hidden mb-4" style="height: 300px;">
                              <h5 class="card-header">Denetçi Kontrol&nbsp;&nbsp;&nbsp;&nbsp;<button
                                  class="btn btn-xs btn-outline-success" type="button"
                                  data-bs-toggle="modal"
                                  data-bs-target="#myModalDenetciKontrol">Tam Ekran Gör
                                </button>
                              </h5>
                            ...
                            <div class="modal fade" id="myModalDenetciKontrol" data-bs-backdrop="static" tabindex="-1">
                              <div class="modal-dialog modal-fullscreen" role="document">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h4 class="modal-title" id="modalScrollableTitle">Denetçi Kontrol</h4>
                                  ...
                                  <div class="modal-body">
                                    <div class="card overflow-hidden mb-4">
                                      ...
                                      <div class="card-body" id="vertical-div-scrollbar">
                                        <div id="divdenetcikontrolmodal"></div>
                                      </div>
                                    </div>
                                  </div>
                      ...
                      <div class="row g-4">
                        <div class="col-sm-3">
                          <div class="form-floating form-floating-outline">
                            ...
                            <label for="enyscalisansayisi">EnYS Çalışan Sayısı</label>
                          </div>
                        </div>
                        <div class="col-sm-3">
                          <div class="form-floating form-floating-outline">
                ...
                <div class="card">
                  ...
                  <div class="card-datatable text-nowrap">
                    ...
                    @if($inceleneceksahasayisi === 0 && !$iso27001)
                ...
                <div class="card">
                  <h5 class="card-header">
                    ...
                    <span id="sureHesaplaSpinner" class="spinner-border me-1 text-danger" role="status"
                    ...
                    Toplam saha sayısı: {{$inceleneceksahasayisi}}, Denetlenecek saha
                    sayısı: {{$inceleneceksahasayisisec}}
                  </h5>
                  <div class="card-datatable text-nowrap">
                    <div class="table-responsive text-nowrap">
                      <table class="table">
                        ...
                        @endif
                        @if(intval($inceleneceksahasayisi) > 0)
                          @for($i = 1; $i<=$inceleneceksahasayisi;$i++)
                            <input id="sube<?= $i ?>calsay" type="hidden"
                                   value="<?= $sahaa[$i] + $sahab[$i] + $sahac[$i]; ?>"
                                ...
                                <th scope="row" id="tooltip9001{{$i}}" class="has-tip" data-tooltip aria-haspopup="true"
                                  ...
                                  <div class="input-group">
                                    <div class="input-group-text form-check mb-0">
                                      <input class="form-check-input m-auto" id="chkSube{{$i}}iso9001" type="checkbox"
                                             value="" aria-label="Checkbox for following text input"
                                             onclick="subeSurelerEkle()">
                                    </div>
                            ...
                            @if($iso1400115)
                              <tr>
                                <th scope="row" id="tooltip14001{{$i}}" class="has-tip" data-tooltip
                                    aria-haspopup="true"
                                    title="<?= isset($_SESSION["tooltip14001{{$i}}"]) ?? $_SESSION["tooltip14001{{$i}}"]; ?>">
                                  <div class="input-group">
                                    <div class="input-group-text form-check mb-0">
                                      <input class="form-check-input m-auto" id="chkSube{{$i}}iso14001" type="checkbox"
                                             value="" aria-label="Checkbox for following text input"
                                             onclick="subeSurelerEkle()">
                                    </div>
                            ...
                            @if($iso45001)
                              <tr>
                                <th scope="row" id="tooltip45001{{$i}}" class="has-tip" data-tooltip
                                    aria-haspopup="true"
                                    title="<?= isset($_SESSION["tooltip45001{{$i}}"]) ?? $_SESSION["tooltip45001{{$i}}"]; ?>">
                                  <div class="input-group">
                                    <div class="input-group-text form-check mb-0">
                                      <input class="form-check-input m-auto" id="chkSube{{$i}}iso45001" type="checkbox"
                                             value="" aria-label="Checkbox for following text input"
                                             onclick="subeSurelerEkle()">
                                    </div>
                            ...
                            @if($iso50001)
                              <tr>
                                <th scope="row" id="tooltip50001{{$i}}" class="has-tip" data-tooltip
                                    aria-haspopup="true"
                                    title="<?= isset($_SESSION["tooltip50001{{$i}}"]) ?? $_SESSION["tooltip50001{{$i}}"]; ?>">
                                  <div class="input-group">
                                    <div class="input-group-text form-check mb-0">
                                      <input class="form-check-input m-auto" id="chkSube{{$i}}iso50001" type="checkbox"
                                             value="" aria-label="Checkbox for following text input"
                                             onclick="subeSurelerEkle()">
                                    </div>
                            ...
                            @if($iso27001)
                              <tr>
                                <th scope="row" id="tooltip27001{{$i}}" class="has-tip" data-tooltip
                                    aria-haspopup="true"
                                    title="<?= isset($_SESSION["tooltip27001{{$i}}"]) ?? $_SESSION["tooltip27001{{$i}}"]; ?>">
                                  <div class="input-group">
                                    <div class="input-group-text form-check mb-0">
                                      <input class="form-check-input m-auto" id="chkSube{{$i}}iso27001" type="checkbox"
                                             value="" aria-label="Checkbox for following text input"
                                             onclick="subeSurelerEkle()">
                                    </div>
                        ...
                        <tr>
                          ...
                          <td style="text-align: right">
                            <input type="hidden" id="toplamhamsuretmp" class="form-control form-control-sm" value="0.0"
                                   style="text-align: right" readonly/>
                            <input type="text" id="toplamhamsure" name="toplamhamsure"
                          ...
                          <td style="text-align: right">
                            <input type="hidden" id="toplamindarttmp" class="form-control form-control-sm" value="0.0"
                                   style="text-align: right" readonly/>
                            <input type="text" id="toplamindart" name="toplamindart"
                                   class="form-control form-control-sm" value="0.0"
                                   style="text-align: right" readonly/>
                          </td>
                          <td style="text-align: right">
                          ...
                          <td style="text-align: right">
                            <input type="hidden" id="toplamentindarttmp" class="form-control form-control-sm"
                                   value="0.0"
                                   style="text-align: right" readonly/>
                            <input type="text" id="toplamentindart" name="toplamentindart"
                                   class="form-control form-control-sm" value="0.0"
                                   style="text-align: right" readonly/>
                          </td>
                          <td style="text-align: right">
                            <input type="hidden" id="toplamkalansuretmp" class="form-control form-control-sm"
                                   value="0.0"
                                   style="text-align: right" readonly/>
                            <input type="text" id="toplamkalansure" name="toplamkalansure"
                                   class="form-control form-control-sm" value="0.0"
                                   style="text-align: right" readonly/>
                          </td>
                          <td style="text-align: right">
                            <input type="hidden" id="toplama1suretmp" class="form-control form-control-sm"
                                   value="0.0" style="text-align: right" readonly/>
                            <input type="text" id="toplama1sure" name="toplama1sure"
                                   class="form-control form-control-sm"
                                   value="0.0" style="text-align: right" readonly/>
                          </td>
                          <td style="text-align: right">
                            <input type="hidden" id="toplama2suretmp" class="form-control form-control-sm"
                                   value="0.0" style="text-align: right" readonly/>
                            <input type="text" id="toplama2sure" name="toplama2sure"
                                   class="form-control form-control-sm"
                                   value="0.0" style="text-align: right" readonly/>
                          </td>
                          <td style="text-align: right">
                          ...
                          <td style="text-align: right">
                            <input type="hidden" id="toplamybsuretmp" class="form-control form-control-sm"
                                   value="0.0" style="text-align: right" readonly/>
                            <input type="text" id="toplamybsure" name="toplamybsure"
                                   class="form-control form-control-sm"
                                   value="0.0" style="text-align: right" readonly/>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td style="text-align: right">
                            <input type="hidden" id="toplama1suresaattmp" class="form-control form-control-sm"
                                   value="... Saat" style="text-align: right" readonly/>
                            <input type="text" id="toplama1suresaat" name="toplama1suresaat"
                                   class="form-control form-control-sm"
                                   value="... Saat" style="text-align: right" readonly/>
                          </td>
                          <td style="text-align: right">
                            <input type="hidden" id="toplama2suresaattmp" class="form-control form-control-sm"
                                   value="... Saat" style="text-align: right" readonly/>
                            <input type="text" id="toplama2suresaat" name="toplama2suresaat"
                                   class="form-control form-control-sm"
                                   value="... Saat" style="text-align: right" readonly/>
                          </td>
                          <td style="text-align: right">
                            <input type="hidden" id="toplamgsuresaattmp" class="form-control form-control-sm"
                                   value="0.0" style="text-align: right" readonly/>
                            <input type="text" id="toplamgsuresaat" name="toplamgsuresaat"
                                   class="form-control form-control-sm"
                                   value="... Saat" style="text-align: right" readonly/>
                          </td>
                          <td style="text-align: right">
                            <input type="hidden" id="toplamybsuresaattmp" class="form-control form-control-sm"
                                   value="... Saat" style="text-align: right" readonly/>
                            <input type="text" id="toplamybsuresaat" name="toplamybsuresaat"
                                   class="form-control form-control-sm"
                                   value="... Saat" style="text-align: right" readonly/>
                          </td>
                        </tr>
                ...
                <div class="col-12 justify-content-between">
                  ...
                  <div id="btnDenetimRaporuYukle" class="{{$asama === "rpyukle" ? "" : " hide"}}">
                    <button class="btn btn-info btn-sm d-grid w-100 mb-1" type="button" data-bs-toggle="offcanvas"
                            data-bs-target="#offcanvasPlanlamadosyasiUpload"
                            aria-controls="offcanvasPlanlamadosyasiUpload">
                      <i class="mdi mdi-upload-outline me-sm-1 me-0"></i> Denetim Raporu ve Ekleri Yükle
                    </button>
                  </div>
                </div>
                ...
                <div class="card">
                  <h5 class="card-header">
                    <div class="col-sm-12 col-lg-12 text-center">
                      ...
                      <div id="divcalendarmonth" class="btn btn-danger btn-sm left"
                           onclick="changeCalendarMonth('current')"><?php echo date("m.Y"); ?></div>
        ...
        @include('_partials/planlama-dosya-yukleme', ['pno' => $pno, 'asama' => $asama])
        ...
        <div class="modal fade" id="myModalbddenetim" data-bs-backdrop="static" tabindex="-1">
          <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title" id="modalScrollableTitle">Önerilen Baş Denetçi</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                <div class="card">
                  <div class="card-datatable text-wrap">
                    <table id="dt-denetim-onerilen-basdenetci"
                           class="dt-denetim-onerilen-basdenetci table table-bordered table-striped" style="width:100%">
                      <thead>
                      <tr>
                        <th style="width:30px">#</th>
                        <th style="width:0px">#</th>
                        <th style="width:100px">Adı Soyadı</th>
                        <th style="width:120px">EA Kod</th>
                        <th style="width:0px">Nace Kodu</th>
                        <th style="width:120px">22000 Kategori</th>
                        <th style="width:0px">Oic/Smiic Kategori</th>
                        <th style="width:0px">Bgys Teknik Alan Kodu</th>
                        <th style="width:120px">Enys Teknik Alan Kodu</th>
                      </tr>
                      </thead>
        ...
        <!-- Denetçi Detay Modal'ı (JavaScript tarafından dinamik olarak oluşturulacak) -->
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <div class="form-check">
                                ...
                                <label class="form-check-label" for="btaltyapi3">3 Birçok farklı BT platformu,
                                  sunucuları,
                                  veri tabanları, ağları </label>
                              </div>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <div class="form-check">
                                ...
                                <label class="form-check-label" for="diskaynak3"> 3 Dış kaynaklara ya da tedarikçiye
                                  olan
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="form-check">
                                ...
                                <label class="form-check-label" for="bilgisistemgelisimi1"> 1 Kuruluş içi
                                  sistem/uygulama
                              ...
                              <div class="form-check">
                                ...
                                <label class="form-check-label" for="bilgisistemgelisimi2"> 2 Bazı önemli iş amaçları
                                  için

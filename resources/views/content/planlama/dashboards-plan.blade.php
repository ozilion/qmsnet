...
@section('content')
  <?php
    if(isset($kiderror))
      \Laravel\Prompts\error($kiderror);
//  print_r($plan);
  ?>
  ...
  <div class="row gy-4 mb-4">
    <div class="col-xl-12">
      <!-- Fixed Header -->
      <div class="card">
        <h5 class="card-header">Belgelendirmeler<a href="{{route('sbasvuruyeni')}}" class="btn btn-primary float-end" target="_blank">Yeni Başvuru</a></h5>
        <div class="card-datatable table-responsive-sm pt-0 text-wrap">
          <table class="dt-dashboard-crm-planlar table table-bordered">
            <thead>
            <tr>
              <th style="max-width:4%">#</th>
              <th style="max-width:6%">Müşteri No</th>
              <th style="max-width:40%">Kuruluş</th>
              <th style="max-width:20%">Standartlar</th>
              <th style="max-width:8%">Denetim tarihi</th>
              <th style="max-width:8%">Sertifika Geç. Tarihi</th>
              <th style="max-width:6%">Kimden</th>
              <th style="max-width:5%">Durum</th>
            </tr>
            </thead>
            <tfoot>
            <tr>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="modalTitle">Plan Detayları</h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                  <p id="modalContent">Burada plan detayları gösterilecek.</p>
                </div>
...
{{--          <h4 class="card-title mb-1 d-flex gap-2 flex-wrap">Tebrikler {{Auth::user()->name}}! 🎉</h4>--}}
...
{{--            <h5 class="mb-2">{{Auth::user()->role}}</h5>--}}
{{--            <p>Toplam başvuru</p>--}}
...
{{--          <div class="dropdown">--}}
{{--            <button class="btn p-0" type="button" id="socialNetworkList" data-bs-toggle="dropdown" aria-haspopup="true"--}}
{{--                    aria-expanded="false">--}}
{{--              <i class="mdi mdi-dots-vertical mdi-24px"></i>--}}
{{--            </button>--}}
...
{{--                <img src="{{asset('assets/img/icons/brands/facebook-rounded.png')}}" alt="facebook" class="me-3"--}}
{{--                     height="34">--}}
{{--              </div>--}}
...
{{--            <li class="d-flex mb-3">--}}
{{--              <div class="flex-shrink-0">--}}
{{--                <img src="{{asset('assets/img/icons/brands/dribbble-rounded.png')}}" alt="dribbble" class="me-3"--}}
{{--                     height="34">--}}
{{--              </div>--}}
{{--              <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">--}}
{{--                <div class="me-2">--}}
...
{{--            <li class="d-flex mb-3">--}}
{{--              <div class="flex-shrink-0">--}}
{{--                <img src="{{asset('assets/img/icons/brands/twitter-rounded.png')}}" alt="facebook" class="me-3"--}}
{{--                     height="34">--}}
{{--              </div>--}}
{{--              <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">--}}
{{--                <div class="me-2">--}}
...
{{--            <li class="d-flex">--}}
{{--              <div class="flex-shrink-0">--}}
{{--                <img src="{{asset('assets/img/icons/brands/instagram-rounded.png')}}" alt="instagram" class="me-3"--}}
{{--                     height="34">--}}
{{--              </div>--}}
{{--              <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">--}}
{{--                <div class="me-2">--}}
...
{{--          <div class="dropdown">--}}
{{--            <button class="btn p-0" type="button" id="meetingSchedule" data-bs-toggle="dropdown" aria-haspopup="true"--}}
{{--                    aria-expanded="false">--}}
{{--              <i class="mdi mdi-dots-vertical mdi-24px"></i>--}}
{{--            </button>--}}
...
{{--          <div class="dropdown">--}}
{{--            <button class="btn p-0" type="button" id="paymentHistory" data-bs-toggle="dropdown" aria-haspopup="true"--}}
{{--                    aria-expanded="false">--}}
{{--              <i class="mdi mdi-dots-vertical mdi-24px"></i>--}}
{{--            </button>--}}

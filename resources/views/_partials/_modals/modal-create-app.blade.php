          ...
          <div class="bs-stepper-header border-0 p-1">
            ...
            <div class="step" data-target="#submit">
              <button type="button" class="step-trigger">
                ...
                <span class="bs-stepper-label flex-column align-items-start gap-1 ps-1 ms-2">
                  <span class="bs-stepper-title text-uppercase fw-normal">{{__('Submit')}}</span>
                  <small class="bs-stepper-subtitle text-muted">{{__('Submit')}}</small>
                </span>
              </button>
            </div>
          </div>
          <div class="bs-stepper-content p-1">
            <form onSubmit="return false">
              ...
              <div id="submit" class="content text-center pt-3 pt-lg-0">
                <h4 class="mb-2 mt-3">{{__('Submit')}}</h4>
                ...
                <div class="col-12 d-flex justify-content-between mt-4 pt-2">
                  ...
                  <button class="btn btn-success btn-submit"><span class="align-middle d-none d-sm-block">{{__('Submit')}}</span><i class="mdi mdi-check ms-2"></i></button>
                </div>
              </div>
            </form>
          </div>

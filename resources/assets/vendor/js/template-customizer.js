      ...
      if (!this._hasControls('rtl') || !rtlSupport) {
        ...
        const rtlCb = e => {
          ...
          if (e.target.value === 'rtl') {
            ...
            window.location.href = baseUrl + 'lang/tr';
          }
        };
...
TemplateCustomizer.LANGUAGES = {
  tr: {
    panel_header: 'Tema Düzenleyici',
    panel_sub_header: 'Gerçek zamanlı düzenle ve önizle',
    theming_header: 'Theming',
    style_label: 'Stil (Mode)',
    theme_label: 'Temalar',
    layout_header: 'Düzen',
    layout_label: 'Menü (Navigasyon)',
    layout_header_label: 'Başlık Türleri',
    content_label: 'İçerik',
    layout_navbar_label: 'Gezinti Çubuğu Türü',
    direction_label: 'Yön'
  },
  en: {

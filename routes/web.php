...
use App\Http\Controllers\Planlama\AuditPlanDocumentController;
use App\Http\Controllers\Planlama\ChecklistController;
use App\Http\Controllers\Planlama\Plan;
use App\Http\Controllers\Planlama\ReportController;
use App\Http\Controllers\Planlama\StandardController;
...
//  Route::get('/dashboards-plan', [Plan::class, 'index'])->name('dashboards-plan');

// plalama
  Route::get('/', [Plan::class, 'basvuruYeni'])->name('sbasvuruyeni');
//  Route::get('/', [Plan::class, 'index'])->name(':rota');
  Route::get('/planlama/dashboards-plan', [Plan::class, 'index'])->name(':rota');
  Route::get('/plan/{asama}/{pno}', [Plan::class, 'planlama'])->name('crm-planlama');
  Route::get('/plan/auditupload/{asama}/{pno}', [Plan::class, 'auditUpload']);
  Route::post('/plan/basvuru', [Plan::class, 'basvuruKaydet'])->name('sbasvuru');
  Route::get('/plan/basvuruyeni', [Plan::class, 'basvuruYeni'])->name('sbasvuruyeni');
  Route::post('/plan/planyeni', [Plan::class, 'planKaydet'])->name('splanyeni');
  Route::post('/plan/plankarar', [Plan::class, 'planKararKaydet'])->name('plankarar');
  Route::post('/plan/sertifika', [Plan::class, 'planSertifika'])->name('planSertifika');
  Route::post('/plan/sertifikaKaydet', [Plan::class, 'planSertifikaKaydet'])->name('planSertifikaKaydet');
// Add these routes to your routes/web.php file

// Audit Plan Routes
  Route::get('/auditPlan/{asama}/{pno}', [AuditPlanDocumentController::class, 'auditPlan'])->name('audit-plan');
  Route::get('/getMaddeNos', [AuditPlanDocumentController::class, 'auditPlanMaddeNos']);
  Route::post('/auditPlanKaydet', [AuditPlanDocumentController::class, 'saveAuditPlan'])->name('audit-plan-kaydet');
// Add this route to your routes/web.php file
  Route::get('/audit-plan-export/{pno}/{asama}/{format}', [AuditPlanDocumentController::class, 'generateAuditPlanDocument'])->name('audit-plan-export');

  Route::get('/dashboard', [DashboardController::class, 'index'])->name('rapor-dashboard');    // Reports
  ...
  Route::get('standards/{standard}/upload-revision', [StandardController::class, 'uploadRevision'])->name('standards.uploadRevision');
  Route::post('standards/{standard}/store-revision', [StandardController::class, 'storeRevision'])->name('standards.storeRevision');
// Add this to your web.php routes file
  Route::post('standards/{standard}/revisions/{revision}/set-current', [\App\Http\Controllers\Planlama\StandardController::class, 'setCurrentRevision'])
    ->name('standards.set_current_revision');

  // Checklists
  Route::resource('checklists', ChecklistController::class)->parameters([
    'checklists' => 'audit'  // This maps 'checklists' resource to {audit} in URLs
  ]);
  Route::get('checklists/{audit}/export', [ChecklistController::class, 'exportDocx'])->name('checklists.export');
//// For edit route
//  Route::get('checklists/{audit}/edit', 'ChecklistController@edit')->name('checklists.edit');
//
//// For show route
//  Route::get('checklists/{audit}/show', 'ChecklistController@show')->name('checklists.show');

  // auditors administrations
  Route::get('/auditor/user-management', [UserManagement::class, 'UserManagement'])->name('auditor-user-management');
  Route::resource('/auditor/user-list', UserManagement::class);
  Route::get('/auditor/application', [AuditorsController::class, 'denetciDosyaIcerigi'])->name('auditor-application');
  Route::get('/auditor/appointment', [AuditorsController::class, 'denetciAtama'])->name('auditor-appointment');
  Route::post('/denetciUserKaydet', [AuditorsController::class, 'denetciUserKaydet']);
  Route::get('/app/user/view/account/{id}', [AuditorsController::class, 'index'])->name('user-view-account');
  Route::match(['get', 'post'], '/app/user/audit/log/{id}', [AuditorsController::class, 'auditLogView']);
  Route::match(['get', 'post'], '/app/user/periodic/site/monitoring/{id}', [AuditorsController::class, 'periyodicSiteMonitoringView']);
  Route::get('/audit/log/{uid}', [AuditorsController::class, 'auditLog']);
  Route::get('/site/monitoring/{uid}', [AuditorsController::class, 'periyodicSiteMonitoring']);
  Route::post('/site/monitoring/{uid}', [AuditorsController::class, 'periyodicSiteMonitoring']);
//  Route::post('/denetci/ata', [AuditorsController::class, 'denetciAta'])->name('denetci.ata');
//  Route::get('/denetci/ata', [AuditorsController::class, 'denetciAta'])->name('denetci.ata');
  Route::match(['get', 'post'], '/denetci/ata', [AuditorsController::class, 'denetciAta'])->name('denetci.ata');
//  Route::match(['get', 'post'], '/denetci/ata', 'AuditorsController@denetciAta')->name('denetci.ata');
  Route::get('/denetci/ata/{uid}', [AuditorsController::class, 'denetciAtamaFormuAc']);
  Route::post('/formDenetciAtamaDosyasiYukleRoute', [AuditorsController::class, 'denetciAtamaDosyasiYukle'])->name('denetci-dosyasi-upload');
  Route::post('/denetci/dosya/kontrol', [AuditorsController::class, 'denetciDosyaKontrol']);
  Route::post('/denetci/atama/kontrol', [AuditorsController::class, 'denetciAtamaKontrol']);
  Route::post('denetci/dosya/liste', [AuditorsController::class, 'denetciDosyaListesi']);
  // auditors administrations

  // datatables content routes
  Route::get('/getplanlar', [Plan::class, 'getPlanlar']);
  Route::get('/geteanace', [Plan::class, 'getEaNacekodlari']);
  Route::get('/get22cats', [Plan::class, 'get22Cats']);
  Route::get('/getSmiiccats', [Plan::class, 'getSmiicCats']);
  Route::get('/get27001cats', [Plan::class, 'get27001Cats']);
  Route::get('/get50001cats', [Plan::class, 'get50001Cats']);
  Route::get('/getDenetimOnerilenBasdenetciRoute', [Plan::class, 'getDenetimOnerilenBasdenetci']);
  Route::get('/getOnerilenKararUyeleriRoute', [Plan::class, 'getOnerilenKararUyeleri']);
  Route::get('/getBasdenetciRoute', [Plan::class, 'getBasdenetci']);
  Route::get('/getDenetciRoute', [Plan::class, 'getDenetci']);
  Route::get('/getTeknikUzmanRoute', [Plan::class, 'getTeknikUzman']);
  Route::get('/getGozlemciRoute', [Plan::class, 'getGozlemci']);
  Route::get('/getIkuRoute', [Plan::class, 'getIku']);
  Route::get('/getAdayDenetciRoute', [Plan::class, 'getAdayDenetci']);
  Route::get('/iso9001SureHesaplaRoute', [Plan::class, 'iso9001SureHesapla']);
  Route::get('/iso14001SureHesaplaRoute', [Plan::class, 'iso14001SureHesapla']);
  Route::get('/iso45001SureHesaplaRoute', [Plan::class, 'iso45001SureHesapla']);
  Route::get('/iso50001SureHesaplaRoute', [Plan::class, 'iso50001SureHesapla']);
  Route::get('/iso27001SureHesaplaRoute', [Plan::class, 'iso27001SureHesapla']);
  Route::get('/bgysFaktorDenetimEtkisiRoute', [Plan::class, 'bgysFaktorDenetimEtkisiHesapla']);
  Route::get('/iso22000SureHesaplaRoute', [Plan::class, 'iso22000SureHesapla']);
  Route::get('/isoOicSmiicSureHesaplaRoute', [Plan::class, 'isoOicSmiicSureHesapla']);
  Route::get('/denetciSistemleriRoute', [Plan::class, 'denetciSistemleri']);
  Route::get('/entegreDuzeyleriRoute', [Plan::class, 'getEntegreDuzeyleri']);
  Route::get('/denetimTakvimiRoute', [Plan::class, 'denetimTakvimi']);
  Route::get('/denetciKontrolRoute', [Plan::class, 'denetciKontrol']);
  Route::get('/tblbelgelifirmalarals05Route', [Plan::class, 'belgelifirmalarals05']);
  Route::post('/formDenetimPaketiDosyasiYukleRoute', [Plan::class, 'denetimPaketiUpload'])->name('denetim-dosyasi-upload');
  Route::get('/cevrimGetir/{cevrim}/{pno}/{asama}', [Plan::class, 'checkCevirim'])->name("cevrim-planlama");
  Route::get('/downloadWordFile/{pno}/{asama}/{dosya}', [Plan::class, 'downloadWordFile'])->name('downloadWordFile');
  Route::get('/downloadCertificateFile/{pno}/{asama}/{dosya}', [Plan::class, 'downloadCertificateFile'])->name('downloadCertificateFile');
  Route::get('/downloadZipFile/{dosya}', [Plan::class, 'downloadZipFile'])->name('downloadZipFile');
  Route::get('/als05', [Plan::class, 'als05'])->name('als05');


  Route::get('/chatgpt', [ChatGPTController::class, 'index'])->name('chatgpt');
  Route::post('/chatgpt', [ChatGPTController::class, 'getResponse'])->name('chatgptFORM');
  Route::post('/deepseek', [ChatGPTController::class, 'getDeepseekResponse'])->name('deepseekFORM');
  Route::post('/gemini', [GeminiController::class, 'handlePrompt'])->name('geminiFORM');
  Route::get('/gemini-models', [GeminiController::class, 'listModels'])->name('geminiModels');
  Route::post('/anythingllm', [GeminiController::class, 'getAnythingllmResponse'])->name('anythingllmChatForm');
